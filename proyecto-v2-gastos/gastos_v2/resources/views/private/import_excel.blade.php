                        ...
                        <div class="col-6">
                            <div class="input-group">
                                ...
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="your_file" name="your_file" aria-describedby="inputGroupFileAddon01" lang="es">
                                    <label class="custom-file-label" id="text_file" for="inputGroupFile01">Seleccionar Archivo</label>
                                </div>
                            </div>
                            <br><br>
